const { expect } = require('chai') //assertion library -- 'expect' syntax
const knex = require('knex') //sql query builder with promise-like objects
const fixtures = require('./bookmarks-fixtures')
const app = require('../src/app') //the express instance with configurations and middleware
